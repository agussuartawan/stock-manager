        ...
        <div class="card mb-3">
            <div class="card-body pb-1">
                ...
                <div class="mb-3">
                    ...
                    {!! Form::text('code', $code, ['class' => 'form-control'.$class, 'id' => 'code', 'disabled' =>
                    true]) !!}
                </div>
                ...
                <div class="mb-3">
                    <div class="row">
                        <div class="col">
                            ...
                            {!! Form::select('cure_type_id', $cure_type, null, ['class' => 'form-control
                            form-select'.$class, 'id' =>
                            'cure_type_id']) !!}
                        </div>
                        ...
                        <div class="col">
                            ...
                            {!! Form::select('cure_unit_id', $cure_unit, null, ['class' => 'form-control
                            form-select'.$class, 'id' =>
                            'cure_unit_id']) !!}
                        </div>
                        ...
                        <div class="col">
                            ...
                            {!! Form::select('rack_id', $rack, null, ['class' => 'form-control form-select'.$class, 'id'
                            => 'rack_id']) !!}
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <div class="input-group mb-3">
                                ...
                                {!! Form::text('purchase_price', null, ['class' => 'form-control'.$class, 'id' =>
                                'purchase_price']) !!}
                            </div>
                        ...
                        <div class="col">
                            ...
                            <div class="input-group mb-3">
                                <span class="input-group-text" id="basic-addon1">Rp.</span>
                                {!! Form::text('selling_price', null, ['class' => 'form-control'.$class, 'id' =>
                                'selling_price']) !!}
                            </div>
                        </div>
                    </div>
