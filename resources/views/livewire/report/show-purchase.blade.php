...
<div class="page-heading">
            ...
            <div class="col-12 col-md-6 order-md-2 order-first">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Laporan Obat Masuk
                        </li>
                    </ol>
                </nav>
            </div>
    ...
    <section class="section">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="text-center">Cari laporan obat masuk</h5>
                    </div>
                    <div class="card-body">
        ...
        @if ($purchases)
            <livewire:report.purchases-table />
        @endif
    </section>
</div>
@push('js')
    <script>
        function submit() {
            ...
            window.open(`{{ url('/report/purchases/print?') }}from=${from.value}&until=${until.value}`, '_blank');
        }
    </script>
@endpush
