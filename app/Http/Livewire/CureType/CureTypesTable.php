...
class CureTypesTable extends DataTableComponent
{
    protected $model = CureType::class;
    ...
    public function columns(): array
    {
        return [
            ...
            ->attributes(fn ($row) => [
                ...
                'title' => 'Edit ' . $row->name,
                "wire:click" => '$emit(`edit:cure-type`,' . $row->id . ')'
            ]),
        ];
    }
}
